...
{
echo'
<label>Davcna stevilka podjetja :</label><input type="text" name="DavSt" class="box"/><br /><br />
<label>Davcna stevilka :</label><input type="text" name="DavSt1" class="box"/><br /><br />
...
<input type="hidden" name="update" value="Avto">';
break;
}
case 'Cenik':
{
...
<label> Stevilka sasije:</label><input type="text" name="StevSasije" class="box" /><br/><br />
<label> Davcna stevilka lastnika:</label><input type="text" name="DavStLastnik" class="box" /><br/><br />
<input type="hidden" name="update" value="Racun">';
break;
}
case 'Taksimeter':
{
...
<input type="hidden" name="update" value="Tarifa">';
break;
}
case 'Vgradnja':
{
...
<input type="hidden" name="update" value="Vgradnja">';
break;
}
}
?>
